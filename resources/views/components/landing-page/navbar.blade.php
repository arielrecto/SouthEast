<div class="flex flex-col gap-2 w-full bg-accent sticky top-0">
    <div class="w-full p-2 rounded-lg flex items-center justify-between sticky top-0">
        <div class="flex items-center gap-5">
            ...
            <h1 class="text-primary text-3xl font-bold tracking-wider">
    ...
    {{-- <div class="w-full flex items-end justify-center bg-secondary">
        <div class="flex items-center gap-5">
            ...
            <a href="http://" class="py-2 px-4 hover:bg-accent duration-700 hover:text-primary text-sm tracking-wider">Gallery</a>
